...
//     }
    ...
    [DllImport(JSDll, CallingConvention = CallingConvention.Cdecl)]
    protected static extern void setVector2(int e, float x, float y);
    [DllImport(JSDll, CallingConvention = CallingConvention.Cdecl)]
	protected static extern void setVector3(int e, float x, float y, float z);
    /// <summary>
    /// Sets the object.
    /// TODO
    ...
    public static string getArgStringS(IntPtr vp, int i)
    {
        ...
        {
            throw new Exception("getArgString return NULL.");
//            return string.Empty;
        }
